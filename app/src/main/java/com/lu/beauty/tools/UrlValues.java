...
public class UrlValues {
    ...
    // 推荐 第一级
    public static final String DESIGNER_RECOMMEND_URL = "http://design.zuimeia.com/api/v1/designers/recommend/?page=1&page_size=30";
    // 独立设计师 第一级
    public static final String DESIGNER_INDEPENDENT_URL = "http://design.zuimeia.com/api/v1/designers/category/30/?page=1&page_size=30";
    // 大牌设计师 第一级
    public static final String DESIGNER_BIG_URL = "http://design.zuimeia.com/api/v1/designers/category/31/?page=1&page_size=30";
    // 第二级
