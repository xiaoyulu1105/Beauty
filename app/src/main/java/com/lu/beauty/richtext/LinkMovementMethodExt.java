...
public class LinkMovementMethodExt extends LinkMovementMethod{
    ...
    public static LinkMovementMethodExt getInstance(Handler handler, Class spanClass) {
        for (;;) {
            LinkMovementMethodExt current = INSTANCE.get();
            if (current != null) {
                return current;
            }
            current = new LinkMovementMethodExt(handler, spanClass);
